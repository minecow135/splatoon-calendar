...
async function checkTables() {
    ...
    createTables("splatfest_splatfest", createTable_splatfest_splatfest, errElement);
    ...
    createTables("splatfest_teams", createTable_splatfest_teams, errElement);
    ...
    createTables("splatfest_win", createTable_splatfest_win, errElement);
    ...
    createTables("splatfest_discordSent", createTable_splatfest_discordSent, errElement);
